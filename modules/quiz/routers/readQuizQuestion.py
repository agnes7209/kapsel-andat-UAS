...
from modules.quiz.schema.schemas import ResponseModel

router = APIRouter()

@router.get("/quizquestions/{Quiz_ID}/", response_model=ResponseModel)
def get_quizquestion(Quiz_ID: str, db: Session = Depends(get_db)):
